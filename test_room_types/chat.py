...
while True:
    ...
    def room_typeees():
        prekazky = []
        prekazky_1 = {0: [140, 90, 50, 50], 1: [140, 140, 50, 50], 2: [140, 190, 50, 50], 3: [140, 240, 50, 50], 4: [140, 290, 50, 50], 5: [140, 340, 50, 50], 6: [140, 390, 50, 50], 7: [140, 440, 50, 50], 8: [190, 250, 50, 50], 9: [0, 0, 50, 50], 10: [0, 0, 50, 50], 11: [0, 0, 50, 50], 12: [0, 0, 50, 50], 13: [0, 0, 50, 50], 14: [0, 0, 50, 50]}

...
layout_width, layout_height = 750,50
startovni_poloha_x, startovni_poloha_y = 825, 108
...
layout = pygame.image.load("minimap_layout.png")
layout = pygame.transform.scale(layout, (200, 150))
...
"""
image_width = 50 #x  #<---- Šířka obrázku, dá se volně měnit
image_height = 25 #y
pygame.display.set_caption("ˇIsaacˇ")
...
image_filter_position = [startovni_poloha_x, startovni_poloha_y] #<---- Pozice filtru
# Rooms list
rooms = [1]
...
#Pohyby mapy
move_up = [0, image_height] # y + 30
move_side = [image_width, 0] # x + 60
...
def pohyby_mapy():
    # Room numbers
    #První
    prvni = [startovni_poloha_x, startovni_poloha_y] #POKUD CHCEŠ ZMĚNIT UMÍSTĚNÍ MAPY, ZMĚŇ UMÍSTĚNÍ PRVNÍ ROOMKY   
...
while True:
    ...
    window.blit(layout, (layout_width, layout_height))

...
def room_typeees(): #NEOPRAVOVAT NAZEV JINAK SE TO POJEBE, dik :D
    ...
    if random_int == 1:
        for i in range(len(prekazky_1)):
            if random.randint(1,5) == 1:
                print(random.random())
                prekazky[i] = prekazky_1[i][:]

    elif random_int == 2:
        for i in range(len(prekazky_2)):
            if random.randint(1,5) == 1:
                prekazky[i] = prekazky_2[i][:]

    elif random_int == 3:
        for i in range(len(prekazky_3)):
            if random.randint(1,5) == 1:
                prekazky[i] = prekazky_3[i][:]

    elif random_int == 4:
        for i in range(len(prekazky_4)):
            if random.randint(1,5) == 1:
                prekazky[i] = prekazky_4[i][:]

    elif random_int == 5:
        for i in range(len(prekazky_5)):
            if random.randint(1,5) == 1:
                prekazky[i] = prekazky_5[i][:]

    elif random_int == 6:
        for i in range(len(prekazky_6)):
            if random.randint(1,5) == 1:
                prekazky[i] = prekazky_6[i][:]

    elif random_int == 7:
        for i in range(len(prekazky_7)):
            if random.randint(1,5) == 1:
                prekazky[i] = prekazky_7[i][:]
